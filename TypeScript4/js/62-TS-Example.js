...
let playerName = "Marleen";
let playerLevel = 1; // Ein paar globale Variablen, welche den Spieler darstellen.
...
let monsterName = ["Bobbi", "boss", "Donald", "Justin", "Pika", "putin"]; // length = 3, da 3 Einträge. Von 0-2.
...
let monsterModifers = ["Ist nerviiiig", "Linkshänder", "Bier-Connoisseur", "Verfehlt häufig", "Prokrastiniert", "Müde", "Verwirrt", "Wasserscheu", "Bipolar", "Hat Schnupfen", "Verläuft sich oft"]; // Eine Reihe von zufälligen "Verstärkern" für das Monster.
// -- Initialisierung für viele/variable Anzahl an Monster --
let monsterArray = []; // Das Haupt-Array wurde erstellt und initialisiert!
console.log(monsterArray); // Gebe das Monster-Array einmal zu beginn aus. Es sollte leer sein.
let frisur = ["Pilzkopf", "Fokuhila", "Topfschnitt", "Irokese", "Feuer"];
let getränk = ["Wodka", "Tequilla", "Apfelsaft", "Benzin", "GinTonic"];
let kartoffelchip = [];
let monsterLevel = [];
// ----------- Funktionen ----------- //
...
function generateMonster() {
    ...
    for (let i = 0; i < rndNumb; i++) {
        ...
        let newMonsterLvl = generateMonsterLevel();
        let newMonsterModifier = generateMonsterModifer(); // Eigens-gebaute Funktion, welche ein string-Array zurück gibt.
        let newMonsterFrisur = generateMonsterFrisur();
        let newMonsterLieblingsgetränk = generateMonsterLieblingsGetränk();
        let newMonsterImgPfad = generateMonsterImgPfad();
        let newMonster = {
...
function generateMonsterImgPfad() {
    ...
    let rndNumber = getRNGNumber(monsterName.length);
    newMonsterImgPfad = "imgs/" + monsterName[rndNumber] + ".jpg";
    return newMonsterImgPfad;
}
function generateMonsterFrisur() {
    let newMonsterFrisur = "";
    let rngNumber = getRNGNumber(frisur.length);
    newMonsterFrisur = frisur[rngNumber];
    return "Frisur: " + newMonsterFrisur;
}
function generateMonsterLieblingsGetränk() {
    let newMonsterLieblingsgetränk = "";
    let rngNumber = getRNGNumber(getränk.length);
...
function monsterGenerateHTML(i) {
    ...
    let monsterFrisur = document.createElement("p");
    monsterFrisur.innerHTML = monsterArray[i - 1].monsterFrisur;
    holdingDiv.appendChild(monsterFrisur);
    let monsterLieblingsGetränk = document.createElement("p");
...
function generateMonsterLevel() {
    // Diese Funktion gibt eine zufällige ganze Zahl (zwischen 0 und 350) + 100 zurück.
    let tempMonsterLvl = 0 + getRNGNumber(11);
...
function fightWeakestMonster() {
    ...
    let weakest = monsterArray.length - 1;
    for (let i = monsterArray.length; i > 0; i--) {
...
function updatePlayerLevel(differenz) {
